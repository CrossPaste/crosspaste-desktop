 ...
 * end-to-end agreement are covered by the provider tests; this file pins the
 * raw math to the RFC.
 */
abstract class AbstractSpake2Rfc9382VectorTest {

    protected abstract val ec: PakeEcOps
    ...
    private val m by lazy { ec.toUncompressed(hex(Spake2P256.M_COMPRESSED_HEX)) }
    private val n by lazy { ec.toUncompressed(hex(Spake2P256.N_COMPRESSED_HEX)) }
    ...
    private suspend fun ke(tt: ByteArray): ByteArray = sha256.hasher().hash(tt).copyOf(Spake2P256.KE_LENGTH)
