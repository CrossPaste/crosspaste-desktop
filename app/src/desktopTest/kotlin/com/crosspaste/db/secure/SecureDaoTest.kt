...
class SecureDaoTest {
    ...
    @Test
    fun `saveCryptPublicKey and retrieve with serializedPublicKey`() =
        runTest {
    ...
    @Test
    fun `saveCryptPublicKey with empty byte array`() =
        runTest {
    ...
    @Test
    fun `saveCryptPublicKey with large byte array`() =
        runTest {
    ...
    @Test
    fun `existCryptPublicKey returns true for existing key`() =
        runTest {
    ...
    @Test
    fun `existCryptPublicKey returns false for non-existent key`() =
        runTest {
    ...
    @Test
    fun `deleteCryptPublicKey removes stored key`() =
        runTest {
    ...
    @Test
    fun `deleteCryptPublicKey on non-existent key does not throw`() =
        runTest {
    ...
    @Test
    fun `serializedPublicKey returns null for non-existent key`() =
        runTest {
    ...
    @Test
    fun `store and retrieve multiple keys independently`() =
        runTest {
    ...
    @Test
    fun `delete one key does not affect other keys`() =
        runTest {
