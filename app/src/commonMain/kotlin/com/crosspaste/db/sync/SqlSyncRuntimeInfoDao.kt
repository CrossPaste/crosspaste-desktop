...
class SqlSyncRuntimeInfoDao(private val database: Database) : SyncRuntimeInfoDao {
    ...
    override suspend fun getAllSyncRuntimeInfos(): List<SyncRuntimeInfo> = withContext(ioDispatcher) {
        syncRuntimeInfoDatabaseQueries.getAllSyncRuntimeInfos(SyncRuntimeInfo::mapper).executeAsList()
    }

    override suspend fun getSyncRuntimeInfo(appInstanceId: String): SyncRuntimeInfo? = withContext(ioDispatcher) {
        ...
        withContext(ioDispatcher) {
            val changed = database.transactionWithResult {
                ...
                syncRuntimeInfoDatabaseQueries.getSyncRuntimeInfo(
                    ...
                    val connectChanged = connectInfo != null && (
