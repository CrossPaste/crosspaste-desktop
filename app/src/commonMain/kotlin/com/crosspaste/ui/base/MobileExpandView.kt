...
// Expand view for mobile, not used on desktop, placed here for maximum reuse
@OptIn(ExperimentalFoundationApi::class)
@Composable
fun MobileExpandView(
    title: String,
    ...
    val elevation by animateDpAsState(
        targetValue = if (expand) 4.dp else 0.dp,
        animationSpec = tween(200),
    )

    val iconScale by animateFloatAsState(
        targetValue = if (expand) 1f else 0.8f,
        animationSpec = tween(200),
    )

    val arrowOffset by animateFloatAsState(
        targetValue = if (expand) 8f else 0f,
        animationSpec = tween(200),
    )
