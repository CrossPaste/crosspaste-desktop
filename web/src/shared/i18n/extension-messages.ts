...
export const extensionMessages: Record<string, Record<string, string>> = {
  ...
  de: {
    ...
    no_matching_items: "Keine passenden Einträge",
  ...
  es: {
    ...
    no_matching_items: "No hay elementos coincidentes",
  ...
  fa: {
    ...
    no_matching_items: "هیچ موردی مطابقت ندارد",
  ...
  fr: {
    ...
    no_matching_items: "Aucun élément correspondant",
  ...
  ja: {
    ...
    no_matching_items: "一致する項目はありません",
  ...
  ko: {
    ...
    no_matching_items: "일치하는 항목이 없습니다",
  ...
  pt: {
    ...
    no_matching_items: "Nenhum item correspondente",
